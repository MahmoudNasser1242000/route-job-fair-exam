...
const CustomerChart = ({ }: IProps) => {
    ...
    return (
        <>
            <h2 className='text-center text-[40px] font-extrabold pt-8 flex items-center justify-center flex-wrap'>
                <span>({customerLoading ? "Customer..." : customer[0]?.name}) Treansactions Chart</span>
                <Link
